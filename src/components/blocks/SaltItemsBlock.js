    ...
    try {
      ...
      try {
        ...
        if (response.ok) {
          ...
          try {
            const testResponse = await fetch(`https://sunny-b.onrender.com/recipes/${result.data._id}`);
            if (testResponse.ok) {
          ...
          try {
            const allRecipesResponse = await fetch('https://sunny-b.onrender.com/recipes');
